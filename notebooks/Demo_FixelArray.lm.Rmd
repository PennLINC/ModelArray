...
lm.outputs <- FixelArray.enh.lm (formula, data, phenotypes, scalar, fixel.subset = fixel.subset, 
                              var.terms = var.terms, 
                              var.model = var.model, 
                              overwrite = TRUE,
                              verbose = TRUE, pbar = FALSE, n_cores = 1)
# NOTES: I tested with one fixel #6: same with diretly calling lm
