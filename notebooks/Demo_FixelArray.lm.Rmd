...
# folder_rprofout <- "/home/chenying/Desktop/fixel_project/FixelArray/notebooks"
...
folder_rprofout = "/home/chenying/Desktop/fixel_project/FixelArray"
...
# prof  <- lineprof(FixelArray.lm (formula, fixelarray, phenotypes, scalar, fixel.subset = fixel.subset, 
...
# peakRAM_lm <- peakRAM(FixelArray.lm (formula, fixelarray, phenotypes, scalar, fixel.subset = fixel.subset, 
#                              full.output = full.output,  var.terms = var.terms, var.model = var.model, 
#                              correct.p.value.terms = "none",
#                              correct.p.value.model = c("fdr","bonferroni"),
#                               verbose = TRUE, pbar = TRUE, n_cores = 2))
...
# profvis_lm <- profvis({
#   FixelArray.lm (formula, fixelarray, phenotypes, scalar, fixel.subset = fixel.subset,
#                              full.output = full.output,  var.terms = var.terms, var.model = var.model,
#                              correct.p.value.terms = "none",
#                              correct.p.value.model = c("fdr","bonferroni"),
#                               verbose = TRUE, pbar = TRUE, n_cores = 2)
