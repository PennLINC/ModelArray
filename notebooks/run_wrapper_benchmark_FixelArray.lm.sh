...
date
cmd="bash wrapper_benchmark_FixelArray.lm.sh -s 1 -D josiane -f 0 -S 30 -c 2 -w vmware -M TRUE"
echo $cmd
$cmd
date
...
date
cmd="bash wrapper_benchmark_FixelArray.lm.sh -s 1 -D josiane -f 0 -S 30 -c 1 -w vmware -M TRUE"
echo $cmd
$cmd
date
