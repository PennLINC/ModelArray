...
CircleCI will automatically build the Docker image and push to Docker Hub when there is a GitHub commit to main branch, or when a version is tagged. See the `.circleci/config.yml` file for more details on these setups.
