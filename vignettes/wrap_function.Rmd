...
If you are looking for examples that attach and use multiple scalars (e.g., referencing one scalar as a predictor for another, or exposing all scalars in a wrapped function), also see the companion vignette:
