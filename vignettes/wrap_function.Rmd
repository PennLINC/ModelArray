...
Notice that the analysis name specified in argument `analysis_name` will be used by `ciftistats_write` in the next step when converting results back to dscalar.nii file format. 
