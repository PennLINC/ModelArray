...
Or in R console: `help(<function_name>)`. For example: `help(ModelArray.lm)` \
...
For developers who hope to contribute to our package, you may check out this [documentation for developers](https://pennlinc.github.io/ModelArray/articles/doc_for_developer.html).
